...
public class PokemonBase : ScriptableObject
{
    ...
    // Growth Stats
    // RK : Refer to https://pokemondb.net/pokedex/bulbasaur for growth stats
    [SerializeField] int expYield;
    [SerializeField] GrowthRate growthRate;

    // RK: catching mechanism : https://bulbapedia.bulbagarden.net/wiki/Catch_rate
    // 255 is easy to catch; 0 is impossible to catch
    [SerializeField] int catchRate = 255;

    // RK : Refer to https://pokemondb.net/pokedex/bulbasaur for moves
